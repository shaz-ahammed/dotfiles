...
```zsh
export GH_USERNAME="shaz-ahammed" DOTFILES_BRANCH="master" HOMEBREW_BASE_INSTALL="true"; curl -fsSL "https://raw.githubusercontent.com/${GH_USERNAME}/dotfiles/refs/heads/${DOTFILES_BRANCH}/scripts/fresh-install-of-osx.sh" | zsh; unset HOMEBREW_BASE_INSTALL
```
