...
# curl -fsSL https://raw.githubusercontent.com/shaz-ahammed/dotfiles/master/scripts/fresh-install-of-osx.sh | zsh
...
FIRST_INSTALL=true
[ ! -f "${HOME}/.shellrc" ] && curl -fsSL https://raw.githubusercontent.com/shaz-ahammed/dotfiles/master/files/.shellrc -o "${HOME}/.shellrc"
...
if [ ! -d "${DOTFILES_DIR}" ]; then
  ...
  git clone https://github.com/shaz-ahammed/dotfiles "${DOTFILES_DIR}"
