...
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/shaz-ahammed/dotfiles/master/scripts/osx-defaults.sh)"
#
# or run it without prompt questions:
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/shaz-ahammed/dotfiles/master/scripts/osx-defaults.sh)" -s
#
